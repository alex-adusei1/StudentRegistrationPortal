        ...
        <div class="col-lg-10 col-lg-offset-1">
            <div class="col-lg-12">
                    ...
                    <img src=\"img/dp.jpg\" height=\"250\" width=\"230\">
                        ...
                        <div class=\"col-lg-9\"><div class=\"col-lg-6\"><h3><i class=\"fa fa-id-card\"></i> Student Information</h3>
                        <h4><i class=\"fa fa-user-circle-o\"></i> " . ucwords($stud['sfn'] . " " . $stud['sln']) . " </h4>
                    ...
                    <div class=\"col-lg-3\">
                            <h3>Actions</h3>
                                  <a href=\"?action=deleteStudent&&userid=" . $stud['id'] . "\" class=\"btn btn-danger\"><i class=\"fa fa-user-times\"></i> Delete " . $stud['sfn'] . " " . $stud['sln'] . "</a></div></div></div>";
                    }
                    ?>
            </div>
        </div>
